...
Copy this folder to `evals/<skill-name>/` when adding evals for a new skill.
...
3. `graders/deterministic.py` — Exact checks: frontmatter, headings, YAML validity.
...
2. Grade using `references/output-rubrics.md`.
