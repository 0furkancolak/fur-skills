...
Examples may live inline, in a sibling `examples.md`, or in `skills/_shared/examples/<skill-name>/`.
...
The base `SKILL.md` is provider-agnostic. Provider-specific prompts live in `skills/_shared/overlays/`:
...
See `references/eval-design.md` for the eval template.
