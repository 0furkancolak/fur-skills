...
| Known cause over-delegated | One-line known fix invokes systematic debugging | Bridge fixture expects `used: false` | Use Fur native flow when root cause is known |
